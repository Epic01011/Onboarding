/**
 * Nomenclature d'Activités Française (NAF rév. 2 / NAF 2008)
 * Source : INSEE — nomenclature officielle française des activités économiques.
 * Contient l'intégralité des ~732 codes à 5 caractères (4 chiffres + 1 lettre).
 *
 * Utilisé par `resolveLibelleNAF()` dans sirenApi.ts pour afficher le libellé
 * textuel à partir du code brut renvoyé par l'API gouvernementale.
 */
export const NAF_MAPPING: Record<string, string> = {
  ...
  "0127Z": "Culture de plantes destinées à la préparation de boissons",
  "0128Z": "Culture de plantes à épices, aromatiques, médicinales et pharmaceutiques",
  "0129Z": "Autres cultures permanentes",
  "0130Z": "Culture et production de matériel de multiplication végétative",
  ...
  "0230Z": "Récolte de produits forestiers non ligneux",
  ...
  "0812Z": "Extraction de graviers et sables, extraction d'argiles et de kaolin",
  "0891Z": "Extraction des minéraux chimiques et d'engrais minéraux",
  "0892Z": "Extraction de tourbe",
  "0893Z": "Extraction de sel",
  ...
  "2370Z": "Taille, façonnage et finissage de pierres ornementales et de construction",
  ...
  "2529Z": "Fabrication d'autres réservoirs, citernes et conteneurs en métal",
  ...
  "2740Z": "Fabrication de lampes et de matériel d'éclairage",
  "2750Z": "Fabrication d'appareils ménagers",
  ...
  "3311Z": "Réparation de produits en caoutchouc et en plastique",
  "3312Z": "Réparation de matériel électronique et optique",
  "3313Z": "Réparation de matériel électrique",
  "3314Z": "Réparation de machines et équipements mécaniques",
  ...
  "4329A": "Autres travaux d'installation électrique",
  ...
  "4335Z": "Travaux de stucature et de ragréage",
  ...
  "4920Z": "Transport ferroviaire de fret",
  ...
  "6202B": "Tierce maintenance de systèmes et applications informatiques",
  ...
  "6619A": "Supports juridiques de gestion de patrimoine immobilier",
  ...
  "6622Z": "Activités des agents et courtiers d'assurance",
  ...
  "6832B": "Supports de gestion de patrimoine immobilier",
  ...
  "7311Z": "Création et placement de publicité",
  ...
  "8219Z": "Photocopie, préparation de documents et autres activités de soutien aux opérations de bureau",
  ...
  "8551Z": "Enseignement de disciplines sportives et de loisirs",
  ...
  "8690E": "Activités de rééducation, d'appareillage et de pédicurie-podologie",
  ...
  "9499Z": "Activités des autres organisations associatives n.c.a.",
